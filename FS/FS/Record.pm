...
sub ut_text {
  ...
  $self->getfield($field)
    =~ /^([µ_0123456789aA·¡‡¿‚¬Â≈‰ƒ„√™Ê∆bBcCÁ«dD–eEÈ…Ë»Í ÎÀfFgGhHiIÌÕÏÃÓŒÔœjJkKlLmMnNÒ—oOÛ”Ú“Ù‘ˆ÷ı’¯ÿ∫pPqQrRsSﬂtTuU˙⁄˘Ÿ˚€¸‹vVwWxXyY˝›ˇzZ˛ﬁ \!\@\#\$\%\&\(\)\-\+\;\:\'\"\,\.\?\/\=\[\]\<\>]+)$/
...
#  warn "ut_name allowed alphanumerics: +(sort grep /\w/, map { chr() } 0..255), "\n";
  #$self->getfield($field) =~ /^([\w \,\.\-\']+)$/
  $self->getfield($field) =~ /^([µ_0123456789aA·¡‡¿‚¬Â≈‰ƒ„√™Ê∆bBcCÁ«dD–eEÈ…Ë»Í ÎÀfFgGhHiIÌÕÏÃÓŒÔœjJkKlLmMnNÒ—oOÛ”Ú“Ù‘ˆ÷ı’¯ÿ∫pPqQrRsSﬂtTuU˙⁄˘Ÿ˚€¸‹vVwWxXyY˝›ˇzZ˛ﬁ \,\.\-\']+)$/
